...
<style>
  ...
  .research-header h3 {
    font-size: 1.6rem;
    font-weight: 700;
    color: #8B7355; /* 첫 번째 이미지의 브라운 계열 포인트 컬러 */
    margin: 0;
  }

  /* 본문 영역 (이미지 5.5 : 텍스트 4.5 비율) */
  .research-body {
    display: flex;
    gap: 30px;
...
<div class="research-container">
  ...
  <div class="research-section">
    <div class="research-header">
      <h3>고성능 콘크리트 개발 및 내진성능평가</h3>
    </div>
    <div class="research-body">
      <div class="research-visual">
        <img src="/sassl/images/Research_2.png" alt="고성능 콘크리트 연구">
      </div>
      <div class="research-desc">
        <ul>
          <li>삼중 나노콘크리트 배합기술 개발 및 역학적 성능 향상 규명</li>
          <li>나노 콘크리트-철근 부착성능 평가</li>
          <li>강섬유 보강 콘크리트(SFRC) 구조부재 내진실험 및 접합부 평가</li>
          <li>노후 건축물 리모델링을 위한 RC 전단벽 보강설계기법 제안</li>
        </ul>
      </div>
    </div>
  </div>
  ...
  <div class="research-section">
    ...
    <div class="research-body">
      ...
      <div class="research-desc">
        <ul>
          <li>DIANA FEA 활용 철근콘크리트 전단벽 내진성능 시뮬레이션</li>
          <li>VecTor2를 활용한 벽식구조 휨보강 설계 기술</li>
          <li>MIDAS GEN 선형동적해석 기반 공동주택 리모델링 구조설계</li>
        </ul>
      </div>
    </div>
  </div>
  ...
  <div class="research-section">
    ...
    <div class="research-body">
      ...
      <div class="research-desc">
        <ul>
          <li>디지털 이미지 상관법(DIC) 기반 응력분포 및 균열 계측</li>
          <li>머신러닝 활용 강섬유 보강 콘크리트 대형 보의 전단설계 메커니즘 규명</li>
          <li>데이터 필터링 및 비선형 회귀분석 기반 SFRC 전단설계식 제안</li>
        </ul>
      </div>
    </div>
  </div>
